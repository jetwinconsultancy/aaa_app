 ...
 */
$config['site_title']                 = "Stock GKB";       // Site Title, example.com This is not more functional
$config['admin_email']                = "admin@example.com"; // Admin Email, admin@example.com This is not more functional
...
$config['user_expire']                = 0;      //0         // How long to remember the user (seconds). Set to zero for no expiration
