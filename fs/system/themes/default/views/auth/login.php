         ...
         <section class="body-sign">
            ...
            <div class="panel-body" style="background-color: #F5F5F5; border-radius: 10px;" >
                <div class="text-center"><?php if ($Settings->logo2) {
                                echo '<img src="' . base_url('assets/uploads/logos/logo.jpg') . '" alt="' . $Settings->site_name . '" style="margin-bottom:10px;" height="130" />';
                            } ?></div>
                ...
                <!-- <div class="login-content"> -->
                    ...
                    <div class="form-group mb-lg">
                        <div class="input-group input-group-icon">
                            <input type="text" required="required" class="form-control input-lg" name="identity"
                                   placeholder="<?= lang('username') ?>" style="font-size:18px;" />
                    ...
                    <div class="form-action clearfix">
                        ...
                        <button type="submit" class="btn btn-danger btn-lg pull-right"><?= lang('login') ?> &nbsp; 
            ...
            <div class="login-form-div">
                <div class="login-content">
                    ...
                    <div class="form-action clearfix">
                        ...
                        <button type="submit" class="btn btn-lg pull-right"><?= lang('submit') ?> &nbsp;&nbsp; 
