											...
											<div class="col-md-12">
												<div class="col-md-2">
													<select class="form-control input-sm" name="tipepencarian">
														<option value="Auditor">Auditor Name</option>
														<option value="Company">Company Name</option>
														<option value="Individu">Individual Name</option>
													</select>
												</div>
												<div class="col-md-5">
														<input type="text" class="form-control input-sm" id="w2-username" name="pencarian" required placeholder="Search">
												</div>
												<div class="col-md-4">
