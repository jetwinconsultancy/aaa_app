...
if(recurring_below_info != undefined)
{
    ...
    for(var t = 0; t < recurring_below_info.length; t++)
    {
        ...
        $a += '<div class="td" style="width: 150px;"><div class="select-input-group"><select class="input-sm form-control" name="service['+$count_recurring_service_info+']" id="service" style="width:200px !important;"><option value="0" data-invoice_description="" data-amount="">Select Service</option></select><div id="form_service"></div></div></div>';
        ...
        $a += '<div class="td" style="width:150px"><div class="input-group"><input type="text" name="amount['+$count_recurring_service_info+']" class="numberdes form-control text-right amount" value="'+addCommas(recurring_below_info[t]["recurring_service_amount"])+'" id="amount" style="width:150px"/><div id="form_amount"></div></div></div>';
        ...
        $("#body_create_recurring").prepend($a); 
        ...
        for(var j = 0; j < service_category.length; j++)
        {
            ...
            if(category_description != service_category[j]['category_description'])
            {
                if(optgroup != '')
                {
                    $("#form"+$count_recurring_service_info+" #service").append(optgroup);
                }
...
$(document).on('click',"#recurring_service_info_Add",function() {
    ...
    $a += '<div class="td"><div class="select-input-group"><select class="input-sm form-control" name="service['+$count_recurring_service_info+']" id="service" style="width:200px;"><option value="0" data-invoice_description="" data-amount="">Select Service</option></select><div id="form_service"></div></div></div>';
    ...
    $a += '<div class="td" style="width:150px"><div class="input-group"><input type="text" name="amount['+$count_recurring_service_info+']" class="numberdes form-control text-right amount" value="" id="amount" style="width:150px"/><div id="form_amount"></div></div></div>';
    $a += '<div class="td" style="width:150px"><div class="select-input-group"><select class="form-control" style="text-align:right;width: 165px;" name="unit_pricing['+$count_recurring_service_info+']" id="unit_pricing"><option value="0" >Select Unit Pricing</option></select></div></div>';
    ...
    $("#form"+$count_recurring_service_info+" #service").select2();
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                if(response.Status == 1)
                {
                    ...
                    $("#body_create_recurring").prepend($a0); 
...
$(document).on("submit",function(e){
    ...
    if(valid_setup)
    {
        //$("#create_recurring_form").formValidation('destroy');
