...
/*			var form_id = $(element).closest('form').attr('id');*/
	    ...
	    .each(function(){
	        ...
	        th.click(function(){
	            ...
	            if(dateofappointment_asc)
	            {
	            	$("#body_officer").each(function(){
					    $(this).html($(this).find('.sort_id').sort(function(a, b){
					        return ($(b).data('dateofappointment').toLowerCase()) < ($(a).data('dateofappointment').toLowerCase()) ? 1 : -1;
					    }));
					});
	    ...
	    .each(function(){
	        ...
	        th.click(function(){
	            ...
	            if(dateofcessation_asc)
	            {
	            	$("#body_officer").each(function(){
					    $(this).html($(this).find('.sort_id').sort(function(a, b){
					        return ($(b).data('dateofcessation').toLowerCase()) < ($(a).data('dateofcessation').toLowerCase()) ? 1 : -1;
					    }));
					});
    ...
    function get_client_officers()
    {
    	if(client_officers)
		{
			...
			{
				$a="";
				$a += '<form class="tr sort_id" method="post" name="form'+i+'" id="form'+i+'" data-dateofcessation="'+client_officers[i]["date_of_cessation"]+'" data-dateofappointment="'+client_officers[i]["date_of_appointment"]+'" data-position="'+client_officers[i]["position_name"]+'" data-registe_no="'+ (client_officers[i]["identification_no"]!=null ? client_officers[i]["identification_no"] : client_officers[i]["register_no"]) +'" data-name="'+ (client_officers[i]["company_name"]!=null ? client_officers[i]["company_name"] : client_officers[i]["name"]) +'">';
