...
function loadItems1() {
	...
	if (localStorage.getItem('slitems')) {
		...
		$.each(slitems, function () {
			...
			tr_html += '<td><input class="form-control text-center sprice" name="saleprice[]" type="text" value="' + formatDecimal(item_qty) + '" data-id="' + row_no + '" data-item="' + item_id + '" id="saleprice_' + row_no + '" onClick="this.select();"></td>';
			tr_html += '<td class="text-center"><i class="fa fa-times tip pointer sldel" id="' + row_no + '" title="Remove" style="cursor:pointer;"></i></td>';
			newTr.html(tr_html);
