...
$(document).on('click',"#submitDirectorInfo",function(e){
    ...
    $.ajax({ //Upload common input
      ...
      type: "POST",
      data: $('form#apointment_of_director_form').serialize()+ '&transaction_code=' + $('#transaction_code').val() + '&transaction_task_id=' + $('#transaction_task').val() + '&registration_no=' + $('#uen').val(),
      dataType: 'json',
