$(document).on('click',"#submitServiceProposalInfo",function(e){
    ...
    $.ajax({ //Upload common input
      ...
      type: "POST",
      data: $('form#service_proposal_form').serialize()+ '&transaction_code=' + $('#transaction_code').val() + '&transaction_task_id=' + $('#transaction_task').val() + '&client_type=' + $('.client_type').val() + '&client_name=' + tran_company_name,
      dataType: 'json',
