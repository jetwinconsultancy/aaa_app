...
function addFirstFrom()
{
    ...
    $a0 += '<div class="td"><div class="transfer_group mb-md" style="width: 200px"><select class="form-control person_id" style="text-align:right;width: 100%;" name="id['+0+']" id="person_id"><option value="0" >Select ID</option></select></div></div>';
...
$(document).on('change','#person_id',function(e){
    ...
    else
    {
        ...
        //console.log( $(this).parent().parent().parent().find('input[name="field_type['+num+']"]'));
    }
    ...
    {   
        ...
        for(var i = 0; i < transfer_object["officer_id"].length; i++)
        {
                ...
                !function (i) {
                    $.ajax({
                        ...
                        success: function(response){
                            ...
                            $b += '<td>'+addCommas(transfer_object["current_share"][i])+'</td>';
            ...
            else
            {
                ...
                $b2 += '<tr class="confirm_from_add_row5 merge_from_total'+i+'">';
                $b2 += '<td style="width:50px !important;"></td>';
                $b2 += '<td colspan="2">'+addCommas((transfer_object["current_share"][i] - parseInt(removeCommas(transfer_object["share_transfer"][i]))))+'</td>';
