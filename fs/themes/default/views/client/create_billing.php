				...
				<div class="panel-body">
					...
					<table class="table table-bordered table-striped table-condensed mb-none">
						...
						<tr class="recurring_part" style="display: none">
							...
							<td>
								<div class="period-input-group">
									<div class="input-group" style="width: 30%" id="from_datepicker">
										<span class="input-group-addon">
											<i class="far fa-calendar-alt"></i>
										</span>
										<input type="text" class="form-control datepicker from_datepicker" id="from" name="from" data-date-format="dd/mm/yyyy" data-plugin-datepicker value="" disabled>
									</div>
								</div>
							</td>
						</tr>
						<tr class="recurring_part" style="display: none">
							...
							<td>
								<div class="period-input-group">
									<div class="input-group" style="width: 30%" id="to_datepicker">
										<span class="input-group-addon">
											<i class="far fa-calendar-alt"></i>
										</span>
...
<script src="themes/default/assets/js/create_billing.js?v=30eee4fc8d1b59e4584b0d39edfa2082" charset="utf-8"></script>