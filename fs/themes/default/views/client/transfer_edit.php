												...
												<table class="table table-bordered table-striped mb-none" id="datatable-default">
													...
													<tbody>
														...
														<tr>
															...
															<td>
																<?php
																	if($trans->sharetype_name == "Ordinary Share")
																	{
															...
															<td style="text-align: center;"><?=$trans->certificate_no?></td>
															<td style="text-align: center">
																
																<button type="button" class="btn btn-primary delete_transfer" onclick="delete_transfer(this)">Delete</button>
