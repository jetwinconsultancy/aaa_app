				...
				<footer class="panel-footer">
					<div class="row">
						<div class="col-md-12 number text-right">
							...
							<button type="submit" class="btn btn-primary" name="savePendingDocumentFile" id="savePendingDocumentFile">Save</button>
...
<script>
	...
	var pending_document_info = <?php echo json_encode($pending_document_info[0]); ?>;
