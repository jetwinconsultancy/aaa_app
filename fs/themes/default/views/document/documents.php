				...
				<div class="col-sm-7">
					<div class="col-md-5">
						<select class="form-control" name="type">
							...
							<option value="document_name" <?=$_POST['type'] == "document_name"?'selected':'';?>>Document Name</option>
					...
					<div class="col-md-7 person_search_input">
						...
						<input type="hidden" class="form-control submit_document_check_state" name="document_check_state" value="<?=$_POST['document_check_state']?$_POST['document_check_state']:'pending';?>">
					</div>
					<div class="col-sm-12">
						...
						<div class="tab-content">
							...
							<div id="w2-pending" class="tab-pane active">
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-pending" style="width:100%;">
									<thead>
										<tr>
											<th><input type="checkbox" name="selectallpendingdocument" class="selectallpendingdocument"/></th>
									...
									<tbody id="pending_body">
										...
										<tr>
											<td style="width:50px"><input type="checkbox" class="" id="" name="pending_document_checkbox" value="<?=$document_link?>"></td>
...
<script>
	...
	var document_check_state = <?php echo json_encode($_POST['document_check_state']) ?>;
