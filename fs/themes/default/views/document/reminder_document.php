...
<?php echo $breadcrumbs;?>						
	<div class="panel-body">
		<div class="col-md-12">
			...
			<form id="document_reminder">
				<input type="hidden" class="form-control" id="document_reminder_id" name="document_reminder_id" value="<?=$document_reminder[0]->id?>"/>
				...
				<table class="table table-bordered table-striped table-condensed mb-none">
					...
					<tr>
						...
						<td style="padding: 10px 5px;">
                            <input type="text" class="form-control" id="reminder_name" name="reminder_name" value="<?=$document_reminder[0]->reminder_name?>" style="width: 400px;"/>
						...
						<td>
							<div style="width:400px">
							    <div style="margin-right:5px;float: left">
							        <input type="checkbox" name="document_active_checkbox" <?=$document_reminder[0]->document_active_checkbox?'checked':'';?>/>
						...
						<td style="padding: 10px 5px;">
							<div>
	                            <label style="float:left;margin-right: 2px;">
	                                <input type="text" class="form-control" id="before_year_end" name="before_year_end" value="<?=$document_reminder[0]->before_year_end?>" style="width: 100px;">
	                            </label>
					...
					<tr style="display: none">
						...
						<td style="padding: 10px 5px;">
							<div>
	                            <label style="float:left;margin-right: 2px;">
	                                <input type="text" class="form-control" id="before_due_date" name="before_due_date" value="<?=$document_reminder[0]->before_due_date?>" style="width: 100px;">
	                            </label>
					...
					<tr style="display: none">
						...
						<td style="padding: 10px 5px;">
                            <div class="document-input-group" id="start_on" style="width: 220px;position: relative;display: table;border-collapse: separate;">
								...
								<input type="text" class="start_on form-control" name="start_on" data-date-format="dd/mm/yyyy" data-plugin-datepicker value="<?=$document_reminder[0]->start_on?>" style="border-bottom-left-radius: 0;border-top-left-radius: 0;">
				...
				<textarea id="reminder_document_tinymce" class="tinymce" name="reminder_document_content"><?=$document_reminder[0]->document_content?></textarea>
	...
	<script>
		...
		var document_reminder = <?php echo json_encode($document_reminder); ?>;
