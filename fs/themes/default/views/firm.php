										...
										<?php
											...
											foreach($all_firm as $p)
											{
												...
												if($Admin)
												{
													...
													echo "<a href='our_firm/edit/".$p->id."' data-name='".$p->name."' style='cursor:pointer;'>".ucwords(substr($p->name,0,37))."<span id='b".$i."' style='display:none;cursor:pointer'>".substr($p->name,37,strlen($p->name))."</span></a>";
													echo '</td>';
												}
												else
												{
