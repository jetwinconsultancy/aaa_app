...
<footer><!-- <a href="#" id="toTop" class="blue"
    ...
    <p style="text-align:center;width: 100%;height:20px; background: #171717;background-color: #c61156; position:relative;
 bottom:0; margin-bottom: 0px;">&copy; <?= date('Y') . " " . $Settings->site_name; ?>  <?php if ($_SERVER["REMOTE_ADDR"] == '127.0.0.1') {
...
<!-- Vendor -->
		...
		<!-- <script src="themes/default/assets/js/allotment.js"></script> -->
...
//   $.ajax({
//             url: "auth/close_browser", //Change this URL as per your settings
//             success: function(newVal) {
//             }
//         });
// });
