...
<head>
    ...
    <link href="<?= $assets ?>styles/print.css" rel="stylesheet"/>
		...
		<!-- <link href="composer_plugin/node_modules/bootstrap-table/dist/bootstrap-table.min.css" rel="stylesheet"> -->

    	<script type="text/javascript" src="<?= $assets ?>js/jquery-2.0.3.min.js"></script>

    	<!-- <script src="composer_plugin/node_modules/bootstrap-table/dist/bootstrap-table.min.js"></script> -->
		...
		<!-- <link href="composer_plugin/node_modules/bootstrap-table/dist/extensions/fixed-columns/bootstrap-table-fixed-columns.min.css" rel="stylesheet"> -->
		<!-- <script src="composer_plugin/node_modules/bootstrap-table/dist/extensions/fixed-columns/bootstrap-table-fixed-columns.min.js"></script> -->

		<!-- Bootstrap - editable -->
		<!-- <script src="composer_plugin/node_modules/bootstrap-table/dist/extensions/editable/bootstrap-table-editable.min.js"></script> -->

		<!-- <link href="assets/vendor/bootstrap3-editable-1.5.1/bootstrap3-editable/css/bootstrap-editable.css" rel="stylesheet"/> -->
		<!-- <script src="assets/vendor/bootstrap3-editable-1.5.1/bootstrap3-editable/js/bootstrap-editable.min.js"></script> -->

		<!-- END OF bootstrap table plugin -->
		...
		<!-- <link href="https://cdn.datatables.net/1.10.16/css/jquery.dataTables.min.css" media="all" rel="stylesheet" type="text/css"/>
		<link href="https://cdn.datatables.net/buttons/1.5.1/css/buttons.dataTables.min.css" media="all" rel="stylesheet" type="text/css"/> -->

		<!-- for datatable fixed column -->
		<!-- <link rel="stylesheet" href="assets/vendor/jquery-datatables/media/css/jquery.dataTables.min.css" />
		<link rel="stylesheet" href="assets/vendor/jquery-datatables/extensions/FixedColumns/css/dataTables.fixedColumns.min.css" />
		...
		<section class="body">
			...
			<header class="header">
				<div class="logo-container">
					<!-- <?php echo json_encode($logo)?>
					 '<?=base_url("uploads/logo/"+$logo+"")?>' -->
					<!--  <?php base_url(); ?>uploads/logo/<?php echo json_encode($logo)?> -->
					...
					<div id="userbox" class="userbox">
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled">
								...
								<!-- <?php if($Admin && !$Individual) { ?>
								<li id="header_client_access">
									<a href="<?= site_url('auth/client/'); ?>">
									<i class="fas fa-users-cog" style="font-size: 1.2rem;"></i> Client Access</a>
								</li>
								<?php } ?> -->
								<li id="header_user_profile">
									<a href="<?= site_url('users/profile/' . $this->session->userdata('user_id') . '/#cpassword'); ?>"><i class="fas fa-users" style="font-size: 1.2rem;"></i> User Profile</a></li>
								<!-- <?php if($Owner) { ?>
								<li><a href="<?= site_url('system_settings/backups'); ?>">
										<i class="fa fa-gear"></i> Backup</a></li>
								<?php } ?>
								<?php if($Admin && !$Individual) { ?>
			...
			<!-- end: header -->
					...
					<header class="page-header" style="background-color:#c61156;">
										...
										<div class="content">
											<ul>
												...
												<li id="header_transaction">
													<a href="<?= site_url('financial_statement/'); ?>" class="btn-default amber">Report</a>
												</li>
												...
												<!-- <li id="header_transaction">
													<a href="<?= site_url('fs_document_template/'); ?>" class="btn-default amber">FS Document Template</a>
												</li> -->
											</ul>
										</div>
									</div>
