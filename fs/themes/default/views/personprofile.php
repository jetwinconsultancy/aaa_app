																...
																<?php
																	...
																	foreach($person as $p)
																	{
																		...
																		if($p["field_type"] == "individual")
																		{
																			...
																			echo ''.ucwords(substr($p["identification_no"],0,25)).'<span id="g'.$i.'" style="display:none;cursor:pointer">'.substr($p["identification_no"],25,strlen($p["identification_no"])).'</span>';
																				if(strlen($p['identification_no']) > 25)
																				{
																					echo '<a class="tonggle_readmore_person" data-id="g'.$i.'">...</a>';
																				}
																			echo '</td>';
																			echo '<td style="word-break:break-all;">';
echo "<a href='personprofile/edit/".urlencode($p['identification_no'])."' data-name='".$p['name']."' style='cursor:pointer;'>".ucwords(substr($p['name'],0,37))."<span id='b".$i."' style='display:none;cursor:pointer'>".substr($p['name'],37,strlen($p['name']))."</span></a>";
																				if(strlen($p['name']) > 37)
																				{
																		...
																		else
																		{
																			echo '<td>'.ucwords($p["field_type"]).'</td>';
																			echo '<td style="word-break:break-all;">';
																			echo ''.ucwords(substr($p["register_no"],0,25)).'<span id="t'.$i.'" style="display:none;cursor:pointer">'.substr($p["register_no"],25,strlen($p["register_no"])).'</span>';
																				if(strlen($p['register_no']) > 25)
																				{
...
echo "<a href='personprofile/editCompany/".urlencode($p['register_no'])."' data-name='".$p['company_name']."' style='cursor:pointer;'>".ucwords(substr($p['company_name'],0,37))."<span id='b".$i."' style='display:none;cursor:pointer'>".substr($p['company_name'],37,strlen($p['company_name']))."</span></a>";
														...
														<tbody>
															<?php
																...
																foreach($person as $p)
																{
																	...
																	echo '<td style="word-break:break-all;">';
																	echo ''.ucwords(substr($p->identification_no,0,25)).'<span id="v'.$i.'" style="display:none;cursor:pointer">'.substr($p->identification_no,25,strlen($p->identification_no)).'</span>';
																		if(strlen($p->identification_no) > 25)
																		{
														...
														<tbody>
															<?php
																...
																foreach($person as $c)
																{
																	...
																	echo '<td style="word-break:break-all;">';
																	echo ''.ucwords(substr($c->register_no,0,25)).'<span id="z'.$i.'" style="display:none;cursor:pointer">'.substr($c->register_no,25,strlen($c->register_no)).'</span>';
																		if(strlen($c->register_no) > 25)
																		{
...
echo "<a href='personprofile/editCompany/".urlencode($p->register_no)."' data-name='".$c->company_name."' style='cursor:pointer;'>".ucwords(substr($c->company_name,0,37))."<span id='b".$i."' style='display:none;cursor:pointer'>".substr($c->company_name,37,strlen($c->company_name))."</span></a>";
