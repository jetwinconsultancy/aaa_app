    ...
    <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
            ...
            <div class="masthead clearfix">
                <div class="inner">
                    <h3 class="text-center">Promotional Pages</h3>
                </div>
            </div>

            <div class="inner cover">
                <h1 class="cover-heading">Promotional Header</h1>
                <p class="lead">Promote you item or any thing in here</p>
                <p class="lead">
                    Picture allowed ini here
                </p>
            </div>
...
<script type="text/javascript" src="<?=$assets ?&v=30eee4fc8d1b59e4584b0d39edfa2082>js/bootstrap.min.js"></script>
</body>
</html>