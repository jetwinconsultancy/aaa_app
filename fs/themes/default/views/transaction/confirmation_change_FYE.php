<div id="transaction_confirmation_change_FYE">
	<span style="color: inherit; font-size: 2.4rem; letter-spacing: -1px; font-weight: 500; margin-top: 20px; margin-bottom: 10px; font-family: inherit; line-height: 2.1;">New FYE</span><a href="javascript:void(0)" class="btn btn-primary edit_change_FYE" id="edit_change_FYE"style="margin-left: 10px; margin-top: -5px; padding: 6px 10px; font-size: 12px">Edit</a>
	<div id="change_of_FYE_interface">
		<div class="form-group" style="margin-top: 20px">
			<label class="col-xs-2" for="w2-username">Year End: </label>
			<div class="col-xs-8">
				<div class="new_FYE" id="new_FYE"></div>
			</div>
		</div>
	</div>
...
<script src="themes/default/assets/js/confirmation_change_FYE.js?v=30eee4fc8d1b59e4584b0d39edfa2082" charset="utf-8"></script>