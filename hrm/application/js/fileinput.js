...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            //noinspection HtmlUnknownAttribute
            tBtnBrowse = '<div tabindex="500" data-toggle="tooltip" data-trigger="hover" data-original-title="Click To Browse Files To Be Uploaded" class="{css}" {status}>{icon} {label}</div>';//add tooltip
    ...
    $.fn.fileinput.defaults = {
        ...
        elErrorContainer: false, //original is null
