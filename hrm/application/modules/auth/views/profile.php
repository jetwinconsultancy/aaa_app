...
.rules_nav li a:hover {
	color: black !important;
  	background: #e1bee7
}

.rules_nav li a:focus {
	color: black !important;
  	background: transparent;
}

.rules_nav li.active a:focus {
	color: black !important;
  	background: #ce93d8
}
...
.rules_nav .nav .active a,
.rules_nav .nav .active:hover a,
.rules_nav .nav .active:focus a {
  font-weight: bold;
  padding-left: 30px;
  border-left: 5px solid black;
}

.rules_nav .nav .active span,
.rules_nav .nav .active:hover span,
.rules_nav .nav .active:focus span {
  display: none;
}
		...
		<div class="tab-content">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="col-md-12 text-right" style="margin-top: 10px;">
		                    <input type="button" value="Update" id="update" class="btn btn_purple ">
					...
					<div class="col-lg-12">
						<div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-10">
                                            ...
                                            <!-- <p style="margin-top: 10px;"><?php echo form_submit('change_password', lang('change_password'), 'class="btn btn_purple" id="change_password_button"'); ?> </p> -->
                                ...
                                <div class="col-md-12 text-right" style="margin-top: 10px;">
				                    <input type="button" value="Change Password" id="change_password_button" class="btn btn_purple ">
				                    <?php if ($id != $this->session->userdata('user_id') && $part != "access_client") { ?>
				                    	<a href="<?= base_url();?>auth/users/" class="btn btn-default">Cancel</a>
				                    <?php } ?>
				                    <?php if ($id == $this->session->userdata('user_id') && $part != "access_client") { ?>
			...
			<div id="w2-rules" class="tab-pane">
				<div id="w2-rules" class="tab-pane">
					...
					<span>RULES</span>
					<a href="<?php echo base_url('../secretary/assets/uploads/file/Rules.pdf');?>" title="Download PDF (439KB)" target="_blank" aria-label="Download PDF (439KB)" data-size=" (439KB)" class="file-download">
