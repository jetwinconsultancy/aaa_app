			...
			<div class="col-md-12">
				<div class="tabs">				
					<ul class="nav nav-tabs nav-justify">
						...
						<li class="check_state" data-information="payslip">
							<a href="#w2-payslip" data-toggle="tab" class="text-center">
...
<!-- 
							...
							<table class="table table-bordered table-striped mb-none bond_group" style="width:90%;table-layout: fixed;" id="bond_tbl">
								<thead style="width:100%;">
									<tr>
										<th style="height:35px;width:19%;" valign=middle>Start Date of Bond</th>
										<th style="height:35px;width:19%;" valign=middle>End Date of Bond</th>
										<th style="height:35px;width:17%;" valign=middle>Period of Bond</th>
										<th style="height:35px;width:17%;" valign=middle>Currency</th>
										<th style="height:35px;width:17%;" valign=middle>Bond Allowance</th>
										<th style="height:35px;width:17%;" valign=middle>No of Months Completed</th>
										<th style="height:35px;width:17%;" valign=middle>Total bond allowance</th>
										<?php if($Admin) { ?>
