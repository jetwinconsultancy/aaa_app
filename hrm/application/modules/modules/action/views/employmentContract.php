	                    ...
	                    <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <div style="width: 100%;">
                                    ...
                                    <div style="width: 60%;float:left;margin-bottom:5px;">
						                <input type="text" class="form-control" id="ol_vacation_leave" name="ol_vacation_leave" value="<?=isset($employee_data[0]->days)?$employee_data[0]->days:'' ?>" style="width: 50px;float:left;"/>
