		        	...
		        	<div class="form-group">
	                    <div class="col-md-8" style="margin-left: 20px;">
	                        <label class="checkbox" for="terms">
	                            <input type="checkbox" name="terms" id="terms" onchange="activateButton(this)" value = "1">  I/We have read and agreed with the <a href="<?php echo base_url('../secretary/term_and_condition');?>" target="_blank">Terms & Conditions</a>
	                        </label>
	                    </div>
	                    <div class="clearfix"></div>
	                </div>
