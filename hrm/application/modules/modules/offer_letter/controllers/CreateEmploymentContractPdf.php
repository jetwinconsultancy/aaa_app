...
class CreateEmploymentContractPdf extends MX_Controller {
	...
	public function create_employment_contract_pdf($data)
	{
		...
		<p style="text-align: justify;">All new appointments remain subject to satisfactory performance during the probationary period agreed in Principal Statement. If during this period either party wishes to terminate this Agreement, notice may be given as detailed in your Principal Statement. Alternatively, the Company may extend your probationary period and, in this event, your notice period (and any relevant benefits) will be as those detailed for the probationary period.</p>
		...
		<p style="text-align: justify;">Either party may at any time, terminate the contract of service without giving notice; or if notice has already been given, without waiting for the expiry of that notice, by paying to the other party a sum equal to the amount of salary at the gross rate of pay which would have accrued to the employee during the period of notice for employee not serving the bond. In the case of employee serving the bond, the employee who has not completed the service of the period of bond shall compensate the employer the amount equivalent to additional salaries that have been paid to the employee. For avoidance of doubt, the employee is required to compensate total additional salary paid to the employer from the date of commencement of the most recent bond</p>
		...
		<p style="text-align: justify;">The employee who has not completed the service of the period of bond shall compensate the employer the amount equivalent to additional salaries that have been paid to the employee.</p>
