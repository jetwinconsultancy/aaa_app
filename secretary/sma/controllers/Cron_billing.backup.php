...
class Cron_billing extends CI_Controller {
  ...
  //       }
        ...
        if ($select_contact_persons->num_rows() > 0) 
		{
			...
			for($t = 0; $t < count($select_contact_person); $t++)
			{
				...
				else
				{
					...
					$clarifi_email = "looi@aaa-global.com or paul@aaa-global.com";
        ...
        if ($select_contact_persons->num_rows() > 0) 
		{
			...
			{
            	$email_detail['message'] = $message.'<p>Best regards,<br />Mr Paul Yeap<br />'.$query[0]['name'].'<br />Address: 18 Howard Road, #08-06 Novelty BizCentre, Singapore 369585<br />Tel: (+65) 6246 8801 / (+ 65) 6246 8802</p>';
            }
