...
class system_settings extends MY_Controller
{
    ...
    function backups()
    {
        ...
        foreach ($this->data['dbs'] as $key => $file) {
            $file = basename($file);
            $row[$key]["file"] = $file;
    ...
    function backup_database()
    {
        ...
        /*$q = $this->db->query("SELECT firm_id FROM user_firm where user_id = '".$this->session->userdata('user_id')."'");
        ...
        $this->db->query("CREATE TEMPORARY TABLE client AS (SELECT * FROM client WHERE firm_id IN ". $in.")"); */
        ...
        $this->save_audit_trail("Backup", "Backup File", "Database is backed up.");
    ...
    function restore_database($dbfile)
    {
        ...
        //echo json_encode($this->encrypt->decode($file));
        //$this->db->conn_id->multi_query($file);//$this->encrypt->decode(
        //$this->db->conn_id->close();
        $sql_contents = file_get_contents('./files/backups/' . $dbfile . '.sql');
    ...
    function download_database($dbfile)
    {
        ...
        $this->save_audit_trail("Backup", "Backup File", "Database is downloaded.");
    ...
    function restore_backup($zipfile)
    {
        ...
        $this->save_audit_trail("Backup", "Backup File", "Database is restored.");
    ...
    function delete_database($dbfile)
    {
        ...
        $this->save_audit_trail("Backup", "Backup File", "Database is deleted.");
    ...
    function user_permissions($id = NULL)
    {
        ...
        $bc = array(array('link' => base_url(), 'page' => lang('home')), array('link' => site_url('system_settings'), 'page' => lang('system_settings')), array('link' => '#', 'page' => "Access Right"));
        $meta = array('page_title' => "Access Right", 'bc' => $bc, 'page_name' => "Access Right");
    ...
    function email_history()
    {
        ...
        $this->data['email_history'] = $this->settings_model->getEmailHistory();

        $bc = array(array('link' => base_url(), 'page' => lang('home')), array('link' => site_url('system_settings'), 'page' => "Email History"), array('link' => '#', 'page' => "Email History"));
        $meta = array('page_title' => "Email History", 'bc' => $bc, 'page_name' => "Email History");

        $this->page_construct('settings/email_history', $meta, $this->data);
    }
    ...
    function audit_trail()
    {
        ...
        $this->data['audit_trail'] = $this->settings_model->getAuditTrail();

        $bc = array(array('link' => base_url(), 'page' => lang('home')), array('link' => site_url('system_settings'), 'page' => "Audit Trail"), array('link' => '#', 'page' => "Audit Trail"));
        $meta = array('page_title' => "Audit Trail", 'bc' => $bc, 'page_name' => "Audit Trail");
    ...
    function rules()
    {
        ...
        $bc = array(array('link' => base_url(), 'page' => lang('home')), array('link' => site_url('system_settings'), 'page' => "Rules"), array('link' => '#', 'page' => "Rules"));
        $meta = array('page_title' => "Rules", 'bc' => $bc, 'page_name' => "Rules");
    ...
    function getFirm() {
        ...
        if ($result->num_rows() > 0) 
        {
            ...
            $data = array('status'=>'success', 'tp'=>1, 'msg'=>"All Firm fetched successfully.", 'result'=>$res);
        ...
        { 
            ...
            $data = array('status'=>'success', 'tp'=>1, 'msg'=>"No data can be selected.", 'result'=>$res);
    ...
    function getUser() {
        ...
        $this->db->select("users.id as id, first_name, last_name, users.email, groups.name, active")
            ->from("users")
        ...
        if ($result->num_rows() > 0) 
        {
            ...
            $data = array('status'=>'success', 'tp'=>1, 'msg'=>"All User fetched successfully.", 'result'=>$res);
    ...
    function getAccessRight() {
        ...
        if ($result->num_rows() > 0) 
        {
            ...
            if(!$result) {
              throw new exception("Access Right not found.");
            }

            //$res = array();
            foreach($result as $row) {
                $this->data['access_right'] = $row;
            }

            $data = array('status'=>'success', 'tp'=>1, 'msg'=>"All Access Right fetched successfully.", 'result'=>$this->data);
    ...
    function save_access_right()
    {
        ...
        if(isset($_POST['client_module']))
        {
            $data['client_module'] = $_POST['client_module'];
        }
        else
        {
            $data['client_module'] = "";
        ...
        if(isset($_POST['company_info_module']))
        {
            $data['company_info_module'] = $_POST['company_info_module'];
        }
        else
        {
            $data['company_info_module'] = "";
        }

        if(isset($_POST['officer_module']))
        {
            $data['officer_module'] = $_POST['officer_module'];
        }
        else
        {
            $data['officer_module'] = "";
        ...
        if(isset($_POST['member_module']))
        {
            $data['member_module'] = $_POST['member_module'];
        }
        else
        {
            $data['member_module'] = "";
        ...
        if(isset($_POST['controller_module']))
        {
            $data['controller_module'] = $_POST['controller_module'];
        }
        else
        {
            $data['controller_module'] = "";
        }

        if(isset($_POST['charges_module']))
        {
            $data['charges_module'] = $_POST['charges_module'];
        }
        else
        {
            $data['charges_module'] = "";
        ...
        if(isset($_POST['filing_module']))
        {
            $data['filing_module'] = $_POST['filing_module'];
        }
        else
        {
            $data['filing_module'] = "";
        ...
        {
            $data['register_module'] = $_POST['register_module'];
        }
        else
        {
        ...
        if(isset($_POST['setup_module']))
        {
            $data['setup_module'] = $_POST['setup_module'];
        }
        else
        {
            $data['setup_module'] = "";
        ...
        if(isset($_POST['person_module']))
        {
            $data['person_module'] = $_POST['person_module'];
        }
        else
        {
            $data['person_module'] = "";
        ...
        if(isset($_POST['document_module']))
        {
            $data['document_module'] = $_POST['document_module'];
        }
        else
        {
            $data['document_module'] = "";
        }

        if(isset($_POST['pending_module']))
        {
            $data['pending_module'] = $_POST['pending_module'];
        }
        else
        {
            $data['pending_module'] = "";
        ...
        if(isset($_POST['all_module']))
        {
            $data['all_module'] = $_POST['all_module'];
        }
        else
        {
            $data['all_module'] = "";
        ...
        if(isset($_POST['master_module']))
        {
            $data['master_module'] = $_POST['master_module'];
        }
        else
        {
            $data['master_module'] = "";
        ...
        if(isset($_POST['reminder_module']))
        {
            $data['reminder_module'] = $_POST['reminder_module'];
        }
        else
        {
            $data['reminder_module'] = "";
        }

        if(isset($_POST['report_module']))
        {
            $data['report_module'] = $_POST['report_module'];
        }
        else
        {
            $data['report_module'] = "";
        ...
        if(isset($_POST['billing_module']))
        {
            $data['billing_module'] = $_POST['billing_module'];
        }
        else
        {
            $data['billing_module'] = "";
        ...
        if(isset($_POST['unpaid_module']))
        {
            $data['unpaid_module'] = $_POST['unpaid_module'];
        }
        else
        {
            $data['unpaid_module'] = "";
        ...
        if(isset($_POST['paid_module']))
        {
            $data['paid_module'] = $_POST['paid_module'];
        }
        else
        {
            $data['paid_module'] = "";
        ...
        if(isset($_POST['receipt_module']))
        {
            $data['receipt_module'] = $_POST['receipt_module'];
        }
        else
        {
            $data['receipt_module'] = "";
        ...
        if(isset($_POST['template_module']))
        {
            $data['template_module'] = $_POST['template_module'];
        }
        else
        {
        ...
        $this->db->set($data);
        $this->db->where(array("firm_id" => $_POST["firm"], "user_id" => $_POST["user"]));
        $this->db->update("user_firm");

        redirect("system_settings/user_permissions");
    }
    ...
    function save_audit_trail($modules, $events, $actions)
    {
