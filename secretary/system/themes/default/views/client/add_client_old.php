												...
												<div class="tab-content">
													<div id="w2-account" class="tab-pane active">
														...
														<div class="form-group">
															...
															<div class="col-sm-4">
																<input type="text" class="form-control input-sm" maxlength="20"  name="clientcode" >
															</div>
														...
														<div class="form-group">
															...
															<div class="col-sm-4">
																<input type="text" class="form-control input-sm" maxlength="10"  name="uen" >
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-sm-8">
																<div class="input-group mb-md">
																	...
																	<input type="text" id="date_todolist" class="form-control" name="date_incorporation" style="" data-plugin-datepicker data-date-format="dd/mm/yyyy" data-date-start-date="0d"/>
																</div>
															</div>
														</div>
														<div class="form-group">
															...
															<div class="col-sm-8">
																<input type="text" class="form-control input-sm" id="edit_company_name" name="client_name"  >
															</div>
														</div>
														<div class="form-group">
															<label class="col-xs-4 control-label" for="w2-username">Use Our Registered Address</label>
															<div class="col-xs-8">
																<input type="checkbox" class="" id="" name="use_registered_address" >
															</div>
														</div>
														<div class="form-group">
															...
															<div class="col-sm-8">
																...
																<input style="width: 10%; float: left; margin-right: 10px;" type="text" class="form-control input-sm" id="" name="postal_code">
																<div class="input-group" style="width: 40%;" >
																<input type="text" class="form-control input-sm" id="" name="city"  >
														...
														<div class="form-group">
															...
															<div class="col-sm-8">
																...
																<input style="width: 51%;" type="text" class="form-control input-sm" id="" name="streetname">
															</div>
														</div>
														<div class="form-group">
															<label class="col-sm-4 control-label" for="w2-username"></label>
															<div class="col-sm-8">
																...
																<input style="width: 51%;" type="text" class="form-control input-sm" id="" name="buildingname">
															</div>
														</div>
														<div class="form-group">
															<label class="col-sm-4 control-label" for="w2-username"></label>
															<div class="col-sm-8">
																...
																<input style="width: 5%; float: left; margin-right: 10px;" type="text" class="form-control input-sm" id="" name="unitno">
																<label style="float: left; margin-right: 10px;" >-</label>
																<input style="width: 5%;" type="text" class="form-control input-sm" id="" name="unitno1" >
															</div>
														</div>
														<div class="form-group">
															<label class="col-sm-4 control-label" for="w2-username">Principle Activity 1</label>
															<div class="col-sm-8">
																<input type="text" class="form-control input-sm" id="" name="activity1" >
															</div>
														</div>
														<div class="form-group">
															<label class="col-sm-4 control-label" for="w2-username">Principle Activity 2</label>
															<div class="col-sm-8">
																<input type="text" class="form-control input-sm" id="" name="activity2" >
															</div>
														</div>
														<div class="form-group">
															<label class="col-sm-4 control-label" for="w2-username">Contact Person</label>
															<div class="col-sm-8">
																<input type="text" class="form-control input-sm" id="" name="cp" >
															</div>
														</div>
														<div class="form-group">
															...
															<div class="col-sm-8">
																<div class="input-group">
																	<input id="phone" maxlength="20" placeholder="(123) 123-1234" name="phone" class="form-control" >
																</div>
															</div>
														</div>
														<div class="form-group">
														...
														<div class="form-group hidden">
															...
															<div class="col-sm-8">
																<input type="text" class="form-control input-sm" id="" name="chairman" >
															</div>
														</div>
														<div class="form-group">
															<label class="col-sm-4 control-label" for="w2-username">Listed Company</label>
															<div class="col-sm-8">
																<input type="checkbox" class="" id="" name="listedcompany">
															</div>
														</div>
														<div class="form-group">
															<label class="col-sm-4 control-label" for="w2-username">Former Name</label>
															<div class="col-sm-8">
																<input type="text" class="form-control input-sm" id="" name="formername" >
															</div>
														</div>
														...
														<h3>A. Issued Share Capital</h3>
															<table class="table table-bordered table-striped table-condensed mb-none" >
																...
																<tbody id="body_issued_share_capital">
																	<tr>
																		<td>1</td>
																		<td><input type="text" class="form-control number text-right" value="" name="issued_amount_member[]"/></td>
																		<td><input type="text" class="form-control number text-right" value="" name="no_of_share_member[]"/></td>
																		<td><?php
																			// print_r($sales);
																			$cr[""] = [];
																	...
																	<tr>
																		...
																		<td><input type="text" class="form-control number text-right" value="" name="issued_amount_member[]"/></td>
																		<td><input type="text" class="form-control number text-right" value="" name="no_of_share_member[]"/></td>
																		<td><?php echo form_dropdown('issued_currency_member[]', $cr, '', 'id="currency"  class="form-control" style="width:100%;"');
																		?></td>
																		<td>
																			<?php echo form_dropdown('issued_sharetype_member[]', $bl, '', 'id="slsales"  class="form-control" style="width:100%;"'); ?>
																		</td>
																		<td></td>
																	</tr>
																	<tr>
															...
															<table class="table table-bordered table-striped table-condensed mb-none" >
																...
																<tbody id="body_member_issued_share_capital">
																	...
																	<tr>
																		...
																		<td><input type="text" name="amount_share_paid_member_capital[]"  nameclass="form-control number text-right" value=""/></td>
													...
													<div id="w2-charges" class="tab-pane">
														...
														<tbody id="body_chargee">
															<tr>
																<td><input type="text" name="chargee_name[]" class="form-control input-xs" value=""/></td>
																<td><input type="text" name="chargee_nature_of[]" class="form-control" value=""/></td>
																<td><input type="text" name="chargee_date_reg[]" id=chargee_date_reg1" class="form-control" data-plugin-datepicker data-date-format="dd/mm/yyyy" /></td>
																<td><input type="text" name="chargee_no[]" class="form-control" value=""/></td>
																<td>
																	<?php echo form_dropdown('chargee_currency[]', $cr, '', 'id="currency"  class="form-control" style="width:100%;"');
																		?>
																</td>
																<td><input type="text" name="chargee_amount[]" class="form-control number" value=""/></td>
																
															</tr>
															<tr>
																<td></td>
																<td></td>
																<td><input type="text" name="chargee_date_satisfied[]" class="form-control " data-plugin-datepicker data-date-format="dd/mm/yyyy" value=""/></td>
																<td><input type="text" name="chargee_satisfied_no[]" class="form-control" value=""/></td>
																<td></td>
																<td></td>
														...
														<div class="form-group">
															...
															<div class="col-sm-8">
																<?php echo form_dropdown('doccategory', $doc_category, '', 'id="currency"  class="form-control" style="width:100%;"');
																		?>
																<!--select data-plugin-selectTwo class="form-control populate" name="others_category">
																	<optgroup label="Type">
													...
													<div id="w2-setup" class="tab-pane">
														...
														<div class="form-group">
															...
															<div class="col-sm-8">
																<select data-plugin-selectTwo name="setup_chairman" class="form-control populate">
																	<optgroup label="Shareholder">
																		<option value="AK" Selected>Dart</option>
																		<option value='VD' >Varder</option>
																		<option value='HK'>Director 1</option>
																	</optgroup>
																</select>
															</div>
														</div>
														<div class="form-group">
															...
															<div class="col-sm-8">
																<select data-plugin-selectTwo name="setup_director_signature1" class="form-control populate">
																	<optgroup label="Director">
																		<option value="AK">Dart</option>
																		<option value='VD' Selected>Varder</option>
																		<option value='HK'>Director 1</option>
																	</optgroup>
																</select>
															</div>
														...
														<div class="form-group">
															...
															<div class="col-sm-8">
																<select data-plugin-selectTwo name="setup_director_signature2" class="form-control populate">
																	<optgroup label="Shareholder">
																		<option value="AK">Dart</option>
																		<option >Varder</option>
																		<option Selected>Director 1</option>
																	</optgroup>
																</select>
															</div>
														</div>
														...
														<table class="table table-bordered">
															...
															<tr>
																<td class="ads1">1</td>
																<td>
																	<select data-plugin-selectTwo name="service_name[]" class="form-control populate">
																		<optgroup label="Shareholder">
																			<option value="AK">Service1</option>
																			<option value="HI">Service2</option>
																...
																<td>
																	<select data-plugin-selectTwo name="service_frequency[]"
															<tr>
																<td class="ads1">2</td>
																<td>
																	<select data-plugin-selectTwo class="form-control populate">
																...
																<td>
																	<input type="text" class="form-control numberdes text-right" value=""/>
																</td>
																<td>
																	<span style="float:left;margin:5px 3px;width:20%;">Start Date</span><input type="text" class="form-control" style="float:left;width:75%;" data-date-format="dd/mm/yyyy" data-date-start-date="0d" data-plugin-datepicker/>
																	<br/>
																	<span style="float:left;margin:3px;width:20%;">End Date</span><input type="text" class="form-control" style="float:left;width:75%;" name="date" data-date-format="dd/mm/yyyy" data-date-start-date="0d" data-plugin-datepicker>
																</td>
																<td>
																	<select data-plugin-selectTwo class="form-control populate">
																		<optgroup label="Frequency">
																			<option value="AK">1 Month</option>
																			<option value="HI">2 Month</option>
...
<script>
	...
	$byk_chargee =1;
			$(document).on('click',"#chargee_Add",function() {
				...
				// $b = $("#body_chargee").html();
				$a += '<tr>';
				$a += '<td><input type="text" name="chargee_name[]" class="form-control input-xs" value=""/></td>';
