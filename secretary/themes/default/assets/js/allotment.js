...
function confirmFunction(allotment_object, latest_certificate)
{
	...
	{	
		var last_certificate_no = latest_certificate;
		for(var i = 0; i < allotment_object["id"].length; i++)
		{
			...
			//         success: function(response){
			            ...
			            $b += '<th colspan="2">Certificate No. <span data-toggle="tooltip" data-trigger="hover" data-original-title="Please insert number for certificate number." style="font-size:14px;"><i class="fa fa-info-circle"></i></span></th>';
			            $b += '</tr>';
				        ...
				        else
				        {
			           	...
			           	{
			           		$("#allotment_confirm .cert_remind_tag").text("* Below certificate number are suggested by the system.");
			           		$b2 += '<td colspan="2"><div class="alloment_group"><div style="width:120px"><input type="text" class="hidden form-control cert_id" name="cert_id[]" id="cert_id" value="'+allotment_object["cert_id"][i]+'"/><input type="text" name="new_certificate_no['+i+']" class="form-control new_certificate_no'+i+' edit_certificate_no check_cert_in_live" value="'+(last_certificate_no+1)+'"/></div><div class="validate_edit_allot_from_cert"></div><div class="validate_edit_allot_from_cert_live"></div></div></td>';
			           	}
			            $b2 += '</tr>';
			...
			last_certificate_no = last_certificate_no + 1;
