...
$(document).on('click',"#submitShareAllotmentInfo",function(e){
    ...
    $.ajax({
      ...
      type: "POST",
      data: $('form#share_allotment_form').serialize()+ '&transaction_code=' + $('#transaction_code').val() + '&transaction_task_id=' + $('#transaction_task').val() + '&registration_no=' + $('#uen').val() + '&transaction_master_id=' + $("#transaction_trans #transaction_master_id").val(),
      dataType: 'json',
