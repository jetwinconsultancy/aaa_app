									...
									<div class="panel-body">
										<table class="table table-bordered table-striped table-condensed mb-none" >
											<tr>
												...
												<td>
													<label><input type="radio" id="individual_edit" name="field_type" <?php print $person->individual_status; ?> value="Individual" class="check_stat" data-information="individual" <?php if(isset($person->individual_disabled)) echo ' disabled ';?>/>&nbsp;&nbsp;Individual</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<label><input type="radio" id="company_edit" name="field_type" <?php print isset($person->company_status)?$person->company_status:'' ?> value="company" class="check_stat" data-information="company" <?php if(isset($person->company_disabled)) echo ' disabled ';?>/>&nbsp;&nbsp;Company</label>
												</td>
											</tr>
										</table>
											...
											<?php echo form_open_multipart('', array('id' => 'upload', 'enctype' => "multipart/form-data")); ?>
												<table class="table table-bordered table-striped table-condensed mb-none" id="tr_individual_edit" <?php print $person->individual_table; ?>>
													<input type="hidden" class="form-control input-sm" name="close_page" value="<?=isset($close_page)?$close_page:''?>">
													<input type="hidden" class="form-control input-sm" name="field_type" value="individual">
													<tr>
														<input type="hidden" class="form-control input-sm" id="officer_id" name="officer_id" value="<?=isset($person->id)?$person->id:''?>">
														<th>Identification Type</th>
														<td>
															<select class="form-control" id="identification_type" name="identification_type">
																<option value="NRIC (Singapore citizen)" <?php 
																if(isset($person->identification_type)){ if($person->identification_type=='NRIC (Singapore citizen)') { echo ' Selected '; } };?>>NRIC (Singapore Citizen)</option>
																<option value="NRIC (PR)" <?php if(isset($person->identification_type)){ if($person->identification_type=='NRIC (PR)') echo ' Selected ';};?>>NRIC (Singapore Permanent Resident)</option>
																<option value="FIN Number" <?php if(isset($person->identification_type)){ if($person->identification_type=='FIN Number') echo ' Selected ';};?>>Passholders</option>
																<option value="Passport/ Others" <?php if(isset($person->identification_type)){ if($person->identification_type=='Passport/ Others') echo ' Selected ';};?>>Passport/ Others</option>
													...
													<tr>
														...
														<td>
															<input type="hidden" class="form-control input-sm" id="old_identification_no" name="old_identification_no" style="text-transform:uppercase" value="<?=htmlspecialchars((isset($person->identification_no)?$person->identification_no:''), ENT_QUOTES)?>">
															<input type="hidden" class="form-control input-sm" id="company_register_no" name="company_register_no" style="text-transform:uppercase" value="<?=htmlspecialchars((isset($person->register_no)?$person->register_no:''), ENT_QUOTES)?>">
															<input type="text" class="form-control input-xs" id="identification_no" name="identification_no" style="text-transform:uppercase" required value="<?=htmlspecialchars((isset($person->decrypt_identification_no)?$person->decrypt_identification_no:''), ENT_QUOTES)?>">
													...
													<tr>
														...
														<td>
															<div class="input-group mb-md" style="width: 200px;">
																...
																<input type="text" class="form-control input-xs valid" id="id_expiry_date" name="id_expiry_date" data-date-format="dd/mm/yyyy" data-plugin-datepicker="" required="" value="<?=($person->identification_expiry_date != NULL)?$person->identification_expiry_date:''?>" placeholder="DD/MM/YYYY">
															</div>
															<div id="form_id_expiry_date"></div>
														</td>
													</tr>
													<tr>
														<th>Name</th>
														<td><input type="text" class="form-control input-xs" id="name" name="name" style="text-transform:uppercase" value="<?=htmlspecialchars((isset($person->name)?$person->name:''), ENT_QUOTES)?>"/>
														<div id="form_name"></div>
														</td>
													</tr>
													<tr>
														<th>Alias</th>
														<td><input type="text" class="form-control input-xs" id="alias" name="alias" style="text-transform:uppercase" value="<?=htmlspecialchars((isset($person->alias)?$person->alias:''), ENT_QUOTES)?>"/>
														</td>
													</tr>
													<tr>
														<th>Date Of Birth</th>
														<td>
															<div class="input-group mb-md" style="width: 200px;">
																...
																<input type="text" class="form-control input-xs valid" id="date_of_birth" name="date_of_birth" data-date-format="dd/mm/yyyy" data-plugin-datepicker="" required="" value="<?=($person->date_of_birth!='00/00/0000')?(isset($person->date_of_birth)?$person->date_of_birth:''):''?>" placeholder="DD/MM/YYYY">
															</div>
													...
													<tr>
														...
														<td>
															<label>
																<input type="radio" id="local_edit" name="address_type" <?php print isset($person->local_status)?$person->local_status:'' ?> value="Local"/>&nbsp;&nbsp;Local Address
															</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
															<label>
																<input type="radio" id="foreign_edit" name="address_type" <?php print isset($person->foreign_status)?$person->foreign_status:'' ?> value="Foreign"/>&nbsp;&nbsp;Foreign Address
															</label>
														</td>
													</tr>
													<tr id="tr_local_edit" <?php print isset($person->address_type)?($person->address_type=="Local"?'style=""':'style="display:none;"'):'' ?>>
														<th></th>
														<td>
															<div style="width: 100%;">
																...
																<div style="width: 65%;float:left;margin-bottom:5px;">
																	<div class="input-group" style="width: 20%;" >
																		<input type="text" class="form-control input-xs" id="postal_code1" name="postal_code1" style="text-transform:uppercase" value="<?=isset($person->postal_code1)?$person->postal_code1:''?>">
																	</div>
															...
															<div style="margin-bottom:5px;">
																...
																<div style="width: 65%;float:left;margin-bottom:5px;">
																	<div class="input-group" style="width: 84.5%;">
																		<input style="width: 100%; text-transform:uppercase" type="text" class="form-control input-xs" id="street_name1" name="street_name1" value="<?=isset($person->street_name1)?$person->street_name1:''?>">
																	</div>
															...
															<div style="margin-bottom:5px;">
																...
																<div class="input-group" style="width: 55%;" >
																	<input style="width: 100%; text-transform:uppercase" type="text" class="form-control input-xs" id="building_name1" name="building_name1" value="<?=isset($person->building_name1)?$person->building_name1:''?>">
															...
															<div style="margin-bottom:5px;">
																...
																<div style="width: 75%;" > 
																	<div class="" style="width: 10%;display: inline-block">
																		<input style="width: 100%; margin-right: 10px; text-transform:uppercase" type="text" class="form-control input-xs" id="unit_no1" name="unit_no1" value="<?=isset($person->unit_no1)?$person->unit_no1:''?>">
																			<?php echo form_error('unit_no1','<span class="help-block">*','</span>'); ?>
																	</div>
																	<div class="" style="width: 15%;display: inline-block;" >
																		<input style="width: 100%; text-transform:uppercase" type="text" class="form-control input-xs" id="unit_no2" name="unit_no2" value="<?=isset($person->unit_no2)?$person->unit_no2:''?>" maxlength="10">
													...
													<tr id="tr_foreign_edit" <?php print isset($person->address_type)?($person->address_type=="Foreign"?'style=""':'style="display:none;"'):'' ?>>
														<td></td>
														<td colspan="2">
															<div style="width: 100%;">
																<div style="width: 25%;float:left;margin-right: 20px;">
																...
																<div style="width: 65%;float:left;margin-bottom:5px;">
																	<div class="input-group" style="width: 65%;" >
																		<input style="margin-bottom: 5px;" type="text" class="form-control input-xs" id="foreign_address1" name="foreign_address1" value="<?=isset($person->foreign_address1)?$person->foreign_address1:''?>"> 
																	</div>
															...
															<div style="width: 100%;">
																...
																<div style="width: 65%;float:left;margin-bottom:5px;">
																	<div class="input-group" style="width: 65%;" >
																		<input style="margin-bottom: 5px;" type="text" class="form-control input-xs" id="foreign_address2" name="foreign_address2" value="<?=isset($person->foreign_address2)?$person->foreign_address2:''?>">
																	</div>
															...
															<div style="width: 100%;">
																...
																<div style="width: 65%;float:left;margin-bottom:5px;">
																	<div class="input-group" style="width: 65%;" >
																		<input type="text" class="form-control input-xs" id="foreign_address3" name="foreign_address3" value="<?=isset($person->foreign_address3)?$person->foreign_address3:''?>">
																	</div>
													...
													<tr>
														...
														<td>
															<div style="margin-bottom:5px;">
																<label  id="alternate_label_edit" style="float:left;margin-right: 20px;"><input type="hidden" name="alternate_address" value="0"><input type="checkbox" id="alternate_address" name="alternate_address" <?php print isset($person->alternate_address_status)?$person->alternate_address_status:'' ?> value="1"></label>Alternate Address : <br><br>
																<div id="alternate_text_edit" <?php print $person->alternate_text_status; ?>>
																	<div style="width: 100%;">
																		...
																		<div style="width: 65%;float:left;margin-bottom:5px;">
																			<div class="input-group" style="width: 20%;" >
																				<input type="text" style="text-transform:uppercase" class="form-control input-xs" id="postal_code2" name="postal_code2" value="<?=isset($person->postal_code2)?$person->postal_code2:''?>">
																			</div>
																	...
																	<div style="margin-bottom:5px;">
																		...
																		<div style="width: 65%;float:left;margin-bottom:5px;">
																			<div class="input-group" style="width: 84.5%;">
																				<input style="width: 100%; text-transform:uppercase" type="text" class="form-control input-xs" id="street_name2" name="street_name2" value="<?=isset($person->street_name2)?$person->street_name2:''?>">
																			</div>
																	...
																	<div style="margin-bottom:5px;">
																		<label style="width: 25%;float:left;margin-right: 20px;">Building Name :</label>
																		<input style="width: 51%; text-transform:uppercase" type="text" class="form-control input-xs" id="building_name2" name="building_name2" value="<?=isset($person->building_name2)?$person->building_name2:''?>">
																	</div>
																	<div style="margin-bottom:5px;">
																		<label style="width: 25%;float:left;margin-right: 20px;">Unit No :
																		</label>
																		<input style="width: 7%; float: left; margin-right: 3px; text-transform:uppercase" type="text" class="form-control input-xs" id="unit_no3" name="unit_no3" value="<?=isset($person->unit_no3)?$person->unit_no3:''?>">

																		<input style="width: 12%; text-transform:uppercase" type="text" class="form-control input-xs" id="unit_no4" name="unit_no4" value="<?=isset($person->unit_no4)?$person->unit_no4:''?>" maxlength="10">
																	</div>
																</div>
															</div>
														</td>
													...
													<?php if(isset($person->non_verify)?($person->non_verify == 1):false){ ?>
														<tr>
															<th>Verify</th>
															<td>
																<div style="margin-right:5px;float: left">
															        <input type="checkbox" name="non_verify_checkbox" <?=$person->non_verify?'checked':'';?>/>
							                                        <input type="hidden" name="hidden_non_verify_checkbox" value="<?=isset($person->non_verify)?$person->non_verify:''?>"/>
															    </div>
															</td>
														</tr>
													<?php } ?>
												...
												<table class="table table-bordered table-striped table-condensed mb-none" id="tr_company_edit" <?php print $person->company_table; ?>>
													...
													<input type="hidden" class="form-control input-sm" id="officer_company_id" name="officer_company_id" value="<?=isset($person->id)?$person->id:''?>">
													<tr>
														<th>Registration No</th>
														<input type="hidden" class="form-control input-sm" id="old_register_no" name="old_register_no" value="<?=htmlspecialchars(isset($person->register_no)?$person->register_no:'', ENT_QUOTES)?>">
														<input type="hidden" class="form-control input-sm" id="individual_identification_no" name="individual_identification_no" value="<?=htmlspecialchars(isset($person->identification_no)?$person->identification_no:'', ENT_QUOTES)?>">
														<td>
															<input type="text" style="text-transform:uppercase" class="form-control input-xs" id="register_no" name="register_no" value="<?=htmlspecialchars(isset($person->decrypt_register_no)?$person->decrypt_register_no:'', ENT_QUOTES)?>"/>
															<div id="form_register_no"></div>
														</td>
													</tr>
													<tr>
														<th>Company Name</th>
														<td><input type="text" style="text-transform:uppercase" class="form-control input-xs" id="company_name" name="company_name" value="<?=htmlspecialchars(isset($person->company_name)?$person->company_name:'', ENT_QUOTES)?>"/>
															<div>
													...
													<tr>
														<th>UEN issued by ACRA</th>
														<td>
															<input type="text" style="text-transform:uppercase" class="form-control input-xs" id="entity_issued_by_registrar" name="entity_issued_by_registrar" value="<?=htmlspecialchars(isset($person->entity_issued_by_registrar)?$person->entity_issued_by_registrar:'', ENT_QUOTES)?>"/>
														</td>
													</tr>
													<tr>
														<th>Former Name (if any)</th>
														<td><input type="text" style="text-transform:uppercase" class="form-control input-xs" id="company_former_name" name="company_former_name" value="<?=htmlspecialchars(isset($person->company_former_name)?$person->company_former_name:'', ENT_QUOTES)?>"/>
														</td>
													</tr>
													<tr>
														...
														<td>
															<div class="input-group" style="width: 200px;">
																...
																<input type="text" class="form-control input-xs valid" id="date_of_incorporation" name="date_of_incorporation" data-date-format="dd/mm/yyyy" data-plugin-datepicker="" required="" value="<?=isset($person->date_of_incorporation)?$person->date_of_incorporation:''?>" placeholder="DD/MM/YYYY">
															</div>
															<div id="form_date_of_incorporation"></div>
														</td>
													</tr>
													<tr>
														<th>Country of Incorporation<span data-toggle="tooltip" data-html="true" data-trigger="hover" data-original-title="Please fill in the fields according to the Country Code." class="fa fa-info-circle errspan" style="margin-top: 0px !important;"></span></th>
														<!-- <td><input type="text" style="text-transform:uppercase" class="form-control input-xs" id="country_of_incorporation" name="country_of_incorporation" value="<?=isset($person->country_of_incorporation)?$person->country_of_incorporation:''?>"/>
															<div>
																<div id="form_country_of_incorporation"></div>
															</div>
														</td> -->
														<td>
															<select id="country_of_incorporation" class="form-control input-xs country_of_incorporation" name="country_of_incorporation">
											                    <option value="0">Select Country of Incorporation</option>
											                </select>
														</td>
													</tr>
													<tr>
														<th>The Statutes of <span data-toggle="tooltip" data-html="true" data-trigger="hover" data-original-title="Example: Companies Act (Chapter 50)" class="fa fa-info-circle errspan" style="margin-top: 0px !important;"></span></th>
														<td><input type="text" style="text-transform:uppercase" class="form-control input-xs" id="statutes_of" name="statutes_of" value="<?=isset($person->statutes_of)?$person->statutes_of:''?>"/>
														</td>
													</tr>
													<tr>
														<th style="width: 200px">Address</th>
														<td><label><input type="radio" id="company_local_edit" name="address_type" <?php print isset($person->local_status)?$person->local_status:''; ?> value="Local"/>&nbsp;&nbsp;Local Address</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
															<label><input type="radio" id="company_foreign_edit" name="address_type" <?php print isset($person->foreign_status)?$person->foreign_status:''; ?> value="Foreign"/>&nbsp;&nbsp;Foreign Address</label></td>
													</tr>
													<tr id="tr_company_local_edit" <?php print isset($person->address_type)?($person->address_type=="Local"?'style=""':'style="display:none;"'):''; ?>>
														<th></th>
														<td>
															<div style="width: 100%;">
																<div style="width: 25%;float:left;margin-right: 20px;">
																...
																<div style="width: 65%;float:left;margin-bottom:5px;">
																	<div class="" style="width: 20%;" >
																		<input type="text" style="text-transform:uppercase" class="form-control input-xs" id="company_postal_code" name="company_postal_code" value="<?=isset($person->company_postal_code)?$person->company_postal_code:''?>">
																	</div>
															...
															<div style="margin-bottom:5px;">
																...
																<div style="width: 65%;float:left;margin-bottom:5px;">
																	<div class="" style="width: 84.5%;">
																		<input style="width: 100%; text-transform:uppercase" type="text" class="form-control input-xs" id="company_street_name" name="company_street_name" value="<?=isset($person->company_street_name)?$person->company_street_name:''?>">
																	</div>
															...
															<div style="margin-bottom:5px;">
																<label style="width: 25%;float:left;margin-right: 20px;">Building Name :</label>
																<input style="width: 55%; text-transform:uppercase" type="text" class="form-control input-xs" id="company_building_name" name="company_building_name" value="<?=isset($person->company_building_name)?$person->company_building_name:''?>">
															
															</div>
															<div style="margin-bottom:5px;">
																<label style="width: 25%;float:left;margin-right: 20px;">Unit No :</label>
																<input style="width: 10%; float: left; margin-right: 10px; text-transform:uppercase" type="text" class="form-control input-xs" id="company_unit_no1" name="company_unit_no1" value="<?=isset($person->company_unit_no1)?$person->company_unit_no1:''?>">
																<input style="width: 10%; text-transform:uppercase" type="text" class="form-control input-xs" id="company_unit_no2" name="company_unit_no2" value="<?=isset($person->company_unit_no2)?$person->company_unit_no2:''?>">
															
															</div>
														</td>
													</tr>
													<tr id="tr_company_foreign_edit" <?php print isset($person->address_type)?($person->address_type=="Foreign"?'style=""':'style="display:none;"'):''; ?>>
														<th></th>
														<td colspan="2">
															<div style="width: 100%;">
																<div style="width: 25%;float:left;margin-right: 20px;">
																...
																<div style="width: 65%;float:left;margin-bottom:5px;">
																	<div class="input-group" style="width: 65%;" >
																		<input style="margin-bottom: 5px; text-transform:uppercase" type="text" class="form-control input-xs" id="company_foreign_address1" name="company_foreign_address1" value="<?=isset($person->company_foreign_address1)?$person->company_foreign_address1:''?>">
																	</div>
															...
															<div style="width: 100%;">
																...
																<div style="width: 65%;float:left;margin-bottom:5px;">
																	<div class="input-group" style="width: 65%;" >
																		<input style="margin-bottom: 5px; text-transform:uppercase" type="text" class="form-control input-xs" id="company_foreign_address2" name="company_foreign_address2" value="<?=isset($person->company_foreign_address2)?$person->company_foreign_address2:''?>">
																	</div>
															...
															<div style="width: 100%;">
																...
																<div style="width: 65%;float:left;margin-bottom:5px;">
																	<div class="input-group" style="width: 65%;" >
																		<input style="text-transform:uppercase" type="text" class="form-control input-xs" id="company_foreign_address3" name="company_foreign_address3" value="<?=isset($person->company_foreign_address3)?$person->company_foreign_address3:''?>">
																	</div>
													...
													<tr>
														<th>Legal form of the entity <span data-toggle="tooltip" data-html="true" data-trigger="hover" data-original-title="Example: Private limited company" class="fa fa-info-circle errspan" style="margin-top: 0px !important;"></span></th>
														<td><input type="text" style="text-transform:uppercase" class="form-control input-xs" id="legal_form_entity" name="legal_form_entity" value="<?=htmlspecialchars(isset($person->legal_form_entity)?$person->legal_form_entity:'', ENT_QUOTES)?>"/>
														</td>
													</tr>
													<tr>
														<th>Name of coporate entity register <span data-toggle="tooltip" data-html="true" data-trigger="hover" data-original-title="Example: ACRA" class="fa fa-info-circle errspan" style="margin-top: 0px !important;"></span></th>
														<td><input type="text" style="text-transform:uppercase" class="form-control input-xs" id="coporate_entity_name" name="coporate_entity_name" value="<?=htmlspecialchars(isset($person->coporate_entity_name)?$person->coporate_entity_name:'', ENT_QUOTES)?>"/>
														</td>
													</tr>
													<tr>
														<th style="width: 200px">Email</th>
														<td class="added-text-field_email">
															<div class="input-group fieldGroup_company_email" style="display: block !important;">
																<input type="text" class="form-control input-xs check_empty_company_email main_company_email" id="company_email" name="company_email[]" value="<?=isset($person->company_email)?$person->company_email:''?>" style="text-transform:uppercase;"/>
													...
													<tr>
														...
														<td class="added-text-field">
															<div class="input-group fieldGroup_company_phone_number">
																<input type="tel" class="form-control input-xs check_empty_company_phone_number main_company_phone_number hp" id="company_phone_number" name="company_phone_number[]" value="<?=isset($person->company_phone_number)?$person->company_phone_number:''?>"/>
													...
													<?php if(isset($person->non_verify)?($person->non_verify == 1):false){ ?>
														<tr>
															...
															<td>
																<div style="margin-right:5px;float: left">
															        <input type="checkbox" name="non_verify_checkbox" <?=isset($person->non_verify)?'checked':'';?>/>
							                                        <input type="hidden" name="hidden_non_verify_checkbox" value="<?=isset($person->non_verify)?$person->non_verify:''?>"/>
															    </div>
															</td>
														</tr>
...
<script>
	...
	var non_verify = <?php echo json_encode(isset($person->non_verify)?$person->non_verify:'')?>;

	var base_url = '<?php echo base_url() ?>';
	var person = <?php echo json_encode($person); ?>;
	var get_kyc_individual_info = <?php echo json_encode(isset($get_kyc_individual_info)?$get_kyc_individual_info:''); ?>;
	var get_kyc_corporate_info = <?php echo json_encode(isset($get_kyc_corporate_info)?$get_kyc_corporate_info:''); ?>;
	var files = <?php echo json_encode(isset($person->files)?$person->files:''); ?>;
	var company_files = <?php echo json_encode(isset($person->company_files)?$person->company_files:''); ?>;
	var officer_fixed_line_no = <?php echo json_encode(isset($person->officer_fixed_line_no)?$person->officer_fixed_line_no:''); ?>;
	var officer_mobile_no = <?php echo json_encode(isset($person->officer_mobile_no)?$person->officer_mobile_no:''); ?>;
	var officer_email = <?php echo json_encode(isset($person->officer_email)?$person->officer_email:''); ?>;

	var officer_company_email = <?php echo json_encode(isset($person->officer_company_email)?$person->officer_company_email:''); ?>;
	var officer_company_phone_number = <?php echo json_encode(isset($person->officer_company_phone_number)?$person->officer_company_phone_number:''); ?>;
	...
	var tab_aktif = "<?php print isset($person->field_type)?$person->field_type:''; ?>";
...
<script src="themes/default/assets/js/kyc_individual.js?v=50eee4fc8d1b59e4584b0d39edfa2082" charset="utf-8"></script>
<script src="themes/default/assets/js/kyc_corporate.js?v=60eee4fc8d1b59e4584b0d39edfa2082" charset="utf-8"></script>