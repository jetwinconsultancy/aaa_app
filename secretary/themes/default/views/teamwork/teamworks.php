<div class="header_between_all_section">
    <section class="panel">
        <header class="panel-heading">
            ...
            <a class="amber" href="<?=base_url("teamworks/addofficer")?>"><i class="fa fa-users amber" style="font-size:16px;height:45px;"></i> Add Officer</a>
            <a class="amber" href="<?=base_url("teamworks/addcompanykeydate")?>"><i class="fa fa-calendar amber" style="font-size:16px;height:45px;"></i> Add Company Key Date</a>
                <a class="amber" href="<?=base_url("teamworks/add")?>"><i class="fa fa-plus-circle amber" style="font-size:16px;height:45px;"></i> Create Company</a>
