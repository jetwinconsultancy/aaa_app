<div id="w2-service_proposal" class="panel">
	...
	<form id="service_proposal_form" style="margin-top: 20px;">
		<div class="form_div_service_proposal">
		...
		<div style="margin-bottom: 20px;"><span style="font-size: 1.7rem; padding: 0; margin-bottom: 7px 0px 4px 0;">Services</span></div>
		<table class="table table-bordered table-striped table-condensed mb-none" id="service_proposal_table" style="width: 100%; margin-top: 30px">
			<thead>
				<tr>
					<th style="text-align: center;width:50px"></th>
					<th style="text-align: center;width:200px">Service Name</th>
					<th style="text-align: center;width:140px">Currency</th>
					<th style="text-align: center;width:120px">Fee</th>
					<th style="text-align: center;width:170px">Unit Pricing (Per)</th>
					<th style="text-align: center;width:280px">Servicing Firm</th>
					<th style="text-align: center;width:100px"><span id="officers_Add" data-toggle="tooltip" data-trigger="hover" data-original-title="This input field is let the user to arrange Services sequence in Proposal. Please fill in the number and start with 1, 2,..." style="font-size:14px;">Sequence <i class="fa fa-info-circle"></i></span></th>
...
<div id="modal_service_proposal_description" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="height: 100% !important;">	
	<div class="modal-dialog">
		<div class="modal-content">
			<header class="panel-heading">
				<h2 class="panel-title">Change Service Proposal Description</h2>
			</header>
			<div class="panel-body">
				<textarea class="form-control modify_service_proposal" style="min-width: 100%; height: 300px;" ></textarea>
			</div>
			<div class="modal-footer">
				<button type="submit" class="btn btn-primary" name="changeSPContent" id="changeSPContent">Change Content</button>
				<input type="button" class="btn btn-default " data-dismiss="modal" name="cancel_change_content" value="Cancel">
			</div>
		</div>
	</div>
</div>
