										...
										<div class="row datatables-header form-inline">
													...
													<tbody>
														...
														?>
															<td>
																...
																<button type="button" class="btn btn-primary sync_client" onclick="sync_client(this)">Sync Client</button>
											...
											<script>
											 ...
											 //    }); 
												...
												//sync_client
												function sync_client(element){
													var tr = jQuery(element).parent().parent();
													var each_client_id = tr.find('input[name="each_client_id"]').val();

													bootbox.confirm("Are you confirm to sync this client?", function (result) {
											            if (result) 
											            {
															if(each_client_id != undefined)
															{
