                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <div style="width: 100%;">
                                                                        ...
                                                                        <div style="width: 65%;float:left;margin-bottom:5px;">
                                                                            <div style="width: 20%;" >
                                                                            <input type="text" class="form-control" id="branch_name" name="branch_name" value="<?=isset($firm[0]->branch_name)?$firm[0]->branch_name:''?>" style="width: 400px;"/>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div style="width: 65%;float:left;margin-bottom:5px;">
                                                                        ...
                                                                        <div style="width: 100%;">
                                                                            <label><input type="radio" id="local_edit" name="address_type" <?php print isset($firm[0]->local_status)?$firm[0]->local_status:''; ?> value="Local"/>&nbsp;&nbsp;Singapore Address</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><input type="radio" id="foreign_edit" name="address_type" <?php print isset($firm[0]->foreign_status)?$firm[0]->foreign_status:''; ?> value="Foreign"/>&nbsp;&nbsp;Foreign Address</label>
                                                                        </div>
                                                                ...
                                                                <div class="form-group">
                                                                    <div style="width: 100%;">
                                                                        ...
                                                                        <div style="width: 65%;float:left;margin-bottom:5px;">
                                                                            <div style="width: 30%;" >
                                                                                <select id="firm_currency" class="form-control firm_currency" style="width: 100%;" name="firm_currency">
                                                                                    <option value="0">Select Currency</option>
                                                                                </select>
                                                                                <div id="form_firm_currency"></div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <div style="width: 100%;">
                                                                        ...
                                                                        <div style="width: 65%;float:left;margin-bottom:5px;">
                                                                            <div style="width: 30%;" >
                                                                                <select id="firm_jurisdiction" class="form-control firm_jurisdiction" style="width: 100%;" name="firm_jurisdiction">
                                                                                    <option value="0">Select Jurisdiction</option>
                                                                                </select>
                                                                                <div id="form_firm_jurisdiction"></div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div style="width: 100%;">
                                                                        ...
                                                                        <div style="width: 70%;float:left;margin-bottom:5px;padding-left: 0px !important;" class="col-sm-10">
                                                                            <div class="input-group" style="margin-bottom: 5px;" >
                                                                                <input type="checkbox" name="hidden_gst_checkbox" <?=isset($firm[0]->gst_checkbox)?'checked':'';?>/>
                                                                            ...
                                                                            <table class="table table-bordered table-striped table-condensed mb-none gst_table" style="width: 500px; display: none">
                                                                                <thead>
                                                                                    <tr>
                                                                                        <th>Register Date</th>
                                                                                        <th>Deregister Date</th>
                                                                                        <!-- <th></th> -->
                                                                                    </tr>
                                                                                </thead>
                                                                                <tbody id="tbody_gst_firm">
                                                                                    <tr>
                                                                                        <td><input type="hidden" id="gst_firm_id0" name="gst_firm_id[]" value=""/><div class="input-group">
                                                                                            <span class="input-group-addon">
                                                                                                <i class="far fa-calendar-alt"></i>
                                                                                            </span><input type="text" class="register_date form-control" id="register_date0" name="register_date[]" data-date-format="dd/mm/yyyy" data-plugin-datepicker value=""></div></td>
                                                                                        <td><div class="input-group">
                                                                                            <span class="input-group-addon">
                                                                                                <i class="far fa-calendar-alt"></i>
                                                                                            </span><input type="text" class="deregister_date form-control" id="deregister_date0" name="deregister_date[]" data-date-format="dd/mm/yyyy" data-plugin-datepicker value=""></div></td>
                                                                                        <!-- <td><input class="btn btn-primary delete_gst" type="button" id="delete_gst" value="Delete"/></td> -->
                                                                                    </tr>
                                                                                    <!-- <tr>
                                                                                        <td><div class="input-group">
                                                                                            <span class="input-group-addon">
                                                                                                <i class="far fa-calendar-alt"></i>
                                                                                            </span><input type="text" class="register_date form-control" id="register_date" name="register_date[]" data-date-format="dd/mm/yyyy" data-plugin-datepicker value=""></div></td>
                                                                                        <td><div class="input-group"><span class="input-group-addon"><i class="far fa-calendar-alt"></i></span><input type="text" class="deregister_date form-control" id="deregister_date" name="deregister_date[]" data-date-format="dd/mm/yyyy" data-plugin-datepicker value=""></div></td>
                                                                                        <td><input class="btn btn-primary delete_gst" type="button" id="delete_gst" value="Delete"/></td>
                                                                                    </tr> -->
                                                                                </tbody>
                                                                            </table>
                                                ...
                                                <table class="table table-bordered table-striped table-condensed mb-none" id="bank_info_table">
                                                    <thead>
                                                        <div class="tr">
                                                            ...
                                                            <div class="th" id="qr_code" style="text-align: center;width:200px">QR Code</div>
...
<script type="text/javascript" charset="utf-8">
    ...
    var gst_firm = <?php echo json_encode(isset($gst_firm) ? $gst_firm: '');?>;
    var company_code = <?php echo json_encode(isset($company_code) ? $company_code: '');?>;
    var edit_firm_telephone = <?php echo json_encode(isset($firm[0]->firm_telephone) ? $firm[0]->firm_telephone : '');?>;
    var edit_firm_fax = <?php echo json_encode(isset($firm[0]->firm_fax) ? $firm[0]->firm_fax : '');?>;
    var edit_firm_email = <?php echo json_encode(isset($firm[0]->firm_email) ? $firm[0]->firm_email : '');?>;
    var initialPreviewArray = []; 
    var initialPreviewConfigArray = [];
    var base_url = '<?php echo base_url() ?>';
    var files = <?php echo json_encode(isset($firm[0]->file_name) ? $firm[0]->file_name : '');?>;
    var bank_info = <?php echo json_encode(isset($bank_info) ? $bank_info : '');?>;
    var firm_id = <?php echo json_encode(isset($firm_id) ? $firm_id : '');?>;
    var tab = <?php echo json_encode(isset($tab) ? $tab : '');?>;
    var firm_currency = <?php echo json_encode(isset($firm_currency) ? $firm_currency : '');?>;
    var firm_jurisdiction = <?php echo json_encode(isset($firm_jurisdiction) ? $firm_jurisdiction : '');?>;
    var refresh;
</script>
...
$.each(firm_currency, function(key, val) {
    //console.log(val);
    var option = $('<option />');
    option.attr('value', val["id"]).text(val["currency"]);
    if(firm[0]['firm_currency'] != 0 && val["id"] == firm[0]['firm_currency'])
    {
        option.attr('selected', 'selected');
    }
    $("#firm_currency").append(option);
});

$.each(firm_jurisdiction, function(key, val) {
    var option = $('<option />');
    option.attr('value', val['id']).text(val['jurisdiction']);
    if(firm[0]['jurisdiction_id'] != 0 && val["id"] == firm[0]['jurisdiction_id'])
    {
        option.attr('selected', 'selected');
    }
    $("#firm_jurisdiction").append(option);
});

if(gst_firm.length > 0)
{
    for(var h = 0; h < gst_firm.length; h++)
    {
        if(h == 0)
        {
            $("#gst_firm_id0").val(gst_firm[h]["id"]);
            $("#register_date0").val(changeDateFormatWithDash(gst_firm[h]["register_date"]));
            if(gst_firm[h]["deregister_date"] != null)
            {
                $("#deregister_date0").val(changeDateFormatWithDash(gst_firm[h]["deregister_date"]));
            }
        }
        else
        {
            $a = "";
            $a += "<tr>";
            $a += '<td><input type="hidden" id="gst_firm_id'+h+'" name="gst_firm_id[]" value=""/><div class="input-group"><span class="input-group-addon"><i class="far fa-calendar-alt"></i></span><input type="text" class="register_date form-control" id="register_date'+h+'" name="register_date[]" data-date-format="dd/mm/yyyy" data-plugin-datepicker value=""></div></td>';
            $a += '<td><div class="input-group"><span class="input-group-addon"><i class="far fa-calendar-alt"></i></span><input type="text" class="deregister_date form-control" id="deregister_date'+h+'" name="deregister_date[]" data-date-format="dd/mm/yyyy" data-plugin-datepicker value=""></div></td>';
            $a += "</tr>";

            $("#tbody_gst_firm").append($a);

            $('.register_date').datepicker({});
            $('.deregister_date').datepicker({});

            $("#gst_firm_id"+h).val(gst_firm[h]["id"]);
            $("#register_date"+h).val(changeDateFormatWithDash(gst_firm[h]["register_date"]));
            if(gst_firm[h]["deregister_date"] != null)
            {
                $("#deregister_date"+h).val(changeDateFormatWithDash(gst_firm[h]["deregister_date"]));
            }
        }
    }

    var array_gst_firm_length = gst_firm.length - 1;
    if(gst_firm[array_gst_firm_length]["deregister_date"] != "" && gst_firm[array_gst_firm_length]["deregister_date"] != null)
    {
        $a = "";
        $a += "<tr class='auto_add_row'>";
        $a += '<td><input type="hidden" id="gst_firm_id'+h+'" name="gst_firm_id[]" value=""/><div class="input-group"><span class="input-group-addon"><i class="far fa-calendar-alt"></i></span><input type="text" class="register_date form-control" id="register_date'+h+'" name="register_date[]" data-date-format="dd/mm/yyyy" data-plugin-datepicker value=""></div></td>';
        $a += '<td><div class="input-group"><span class="input-group-addon"><i class="far fa-calendar-alt"></i></span><input type="text" class="deregister_date form-control" id="deregister_date'+h+'" name="deregister_date[]" data-date-format="dd/mm/yyyy" data-plugin-datepicker value=""></div></td>';
        $a += "</tr>";
...
$("#firm_currency").live('change',function(){
    $( '#form_firm_currency' ).html("");
});

$("#firm_jurisdiction").live('change',function(){
    $( '#form_firm_jurisdiction' ).html("");
});
    ...
    $.ajax({ //Upload common input
            ...
            success: function (response) {
                ...
                if (response.Status === 1) {
                    ...
                    $('.nav li').removeClass('disabled');
                    var test = $('#logo').fileinput('upload');
                    if(test == undefined)
                    {
                        if(refresh)
                        {
                ...
                else
                {
                    ...
                    if (response.error["firm_currency"] != "")
                    {
                        var errorsFirmCurrency = '<span class="help-block">*' + response.error["firm_currency"] + '</span>';
                        $( '#form_firm_currency' ).html( errorsFirmCurrency );

                    }
                    else
                    {
                        var errorsFirmCurrency = '';
                        $( '#form_firm_currency' ).html( errorsFirmCurrency );
                    }

                    if (response.error["firm_jurisdiction"] != "")
                    {
                        var errorsFirmJurisdiction = '<span class="help-block">*' + response.error["firm_jurisdiction"] + '</span>';
                        $( '#form_firm_jurisdiction' ).html( errorsFirmJurisdiction );

                    }
                    else
                    {
                        var errorsFirmJurisdiction = '';
                        $( '#form_firm_jurisdiction' ).html( errorsFirmJurisdiction );
                    }
                }
            }
...
{console.log(files);
    //console.log(files.constructor === Object);
