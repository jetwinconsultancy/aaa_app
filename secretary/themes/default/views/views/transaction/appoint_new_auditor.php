<div id="w2-officer" class="panel appoint_auditor">
	<h3>Appointment and Resignation of Auditor</h3>
	<form id="apointment_of_auditor_form" style="margin-top: 20px;">
		...
		<button type="button" class="collapsible"><span style="font-size: 2.4rem;">Appointment of Auditor</span></button>
		<div id="company_info" class="incorp_content">
		...
		<button type="button" class="collapsible"><span style="font-size: 2.4rem;">Resignation of Auditor</span></button>
		<div id="company_info" class="incorp_content">
			...
			<div id="no_auditor_resign" style="margin-top: 20px;">
				<div>
