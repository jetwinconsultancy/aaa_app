<div id="transaction_confirmation_change_biz_activity">
	<span style="color: inherit; font-size: 2.4rem; letter-spacing: -1px; font-weight: 500; margin-top: 20px; margin-bottom: 10px; font-family: inherit; line-height: 2.1;">New Business Activity</span><a href="javascript:void(0)" class="btn btn-primary edit_change_biz_activity" id="edit_change_biz_activity"style="margin-left: 10px; margin-top: -5px; padding: 6px 10px; font-size: 12px">Edit</a>
	<div id="change_of_biz_activity_interface">
		...
		<div class="form-group" style="margin-top: 20px">
			...
			<div class="col-xs-8">
				<div class="new_activity1" id="new_activity1"></div>
			</div>
		</div>
		<div class="form-group" style="margin-top: 20px">
			<label class="col-xs-2">Description 1: </label>
			<div class="col-xs-8">
				<div class="new_description1" id="new_description1"></div>
			</div>
		</div>
		<div class="form-group" style="margin-top: 20px">
			<label class="col-xs-2">Activity 2: </label>
			<div class="col-xs-8">
				<div class="new_activity2" id="new_activity2"></div>
			</div>
		</div>
		<div class="form-group" style="margin-top: 20px">
			<label class="col-xs-2">Description 2: </label>
			<div class="col-xs-8">
				<div class="new_description2" id="new_description2"></div>
			</div>
		</div>
		<div class="form-group" style="margin-top: 20px">
...
<script src="themes/default/assets/js/confirmation_change_biz_activity.js?v=30eee4fc8d1b59e4584b0d39edfa2082" charset="utf-8"></script>