			...
			<div class="modal-text">
				...
				<div id="w2-companyInfo" class="incorp_content">
				  <?php echo form_open_multipart('', array('id' => 'upload_company_info', 'enctype' => "multipart/form-data")); ?>
						...
						<div class="form-group" style="margin-top: 20px;">
							...
							<div class="col-sm-8">
								<input type="text" style="text-transform:uppercase" class="form-control" id="edit_company_name" name="company_name"  value="<?=isset($transaction_client->company_name) ? $transaction_client->company_name : ''?>">
						...
						<div class="form-group" style="margin-top: 20px">
							...
							<div class="col-sm-8 div_autocomplete">
								<input type="text" style="text-transform:uppercase" class="form-control" id="activity1" name="activity1" value="<?= isset($transaction_client->activity1) ? $transaction_client->activity1 : ''?>" >
								<div id="form_activity1"></div>
							</div>
						</div>
						
						<div class="form-group" style="margin-top: 20px">
							<label class="col-sm-2" for="w2-username">Description 1: </label>
							<div class="col-sm-8">
								<textarea rows="4" cols="50" style="text-transform:uppercase" class="form-control" id="description1" name="description1"><?= isset($transaction_client->activity1) ? $transaction_client->activity1 : ''?>
								</textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8 div_autocomplete">
								<input type="text" style="text-transform:uppercase" class="form-control" id="activity2" name="activity2" value="<?= isset($transaction_client->activity2) ? $transaction_client->activity2 : ''?>" >
								<div id="form_activity2"></div>
							</div>
						</div>

						<div class="form-group" style="margin-top: 20px">
							<label class="col-sm-2" for="w2-username">Description 2: </label>
							<div class="col-sm-8">
								<textarea rows="4" cols="50" style="text-transform:uppercase" class="form-control" id="description2" name="description2" value="<?= isset($transaction_client->description2) ? $transaction_client->description2 : ''?>">
								</textarea>
							</div>
						</div>
						...
						<div class="form-group" style="margin-top: 20px">
							...
							<div class="col-xs-8">
								<div class="col-xs-1">
									<input type="checkbox" class="" id="use_registered_address" name="use_registered_address" onclick="fillIncorpRegisteredAddressInput(this);">
								</div>
								...
								<div style="width: 100%;">
									...
									<div style="width: 71%;float:left;margin-bottom:5px;">
										<div class="" style="width: 100%;" >
											<input type="text" style="text-transform:uppercase" class="form-control" id="street_name" name="street_name" value="<?= isset($transaction_client->street_name) ? $transaction_client->street_name : ''?>">
										</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<div style="width: 100%;">
									...
									<div style="width: 71%;float:left;margin-bottom:5px;">
										<div class="" style="width: 100%;" >
											<input type="text" style="text-transform:uppercase" class="form-control" id="building_name" name="building_name" value="<?= isset($transaction_client->building_name) ? $transaction_client->building_name : ''?>">
										</div>
										<div id="form_street_name"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								...
								<input style="width: 8%; float: left; margin-right: 10px; text-transform:uppercase;" type="text" class="form-control" id="unit_no1" name="unit_no1" value="<?=isset($transaction_client->unit_no1) ? $transaction_client->unit_no1 : ''?>" maxlength="3">
								<label style="float: left; margin-right: 10px;" >-</label>
								<input style="width: 14%; text-transform:uppercase;" type="text" class="form-control" id="unit_no2" name="unit_no2" value="<?= isset($transaction_client->unit_no2) ? $transaction_client->unit_no2 : ''?>" maxlength="10">
							</div>
						</div>
						<div class="form-group hidden">
							<label class="col-sm-2" for="w2-username">Listed Company: </label>
							<div class="col-sm-8">
								<input type="checkbox" class="" id="listedcompany" name="listedcompany" <?=isset($transaction_client->listed_company)?'checked':'';?> />
							</div>
						</div>
					<?= form_close(); ?>
					<div class="form-group">
				  	...
				  	<form id="controller_form" style="margin-top: 20px;">
						...
						<thead>
							<tr>
								...
								<th id="id_date_of_birth" style="text-align: center;width:270px;">Date of Birth/Date of Incorporation</th>
								<th style="border-bottom:none;"></th>
							...
							<tr>
								...
								<th id="id_nationality" style="text-align: center;width:270px;">Nationality/Country of Incorporation</th>
				...
				<div id="w2-filing" class="incorp_content">
				  <?php echo form_open_multipart('', array('id' => 'filing_form', 'enctype' => "multipart/form-data")); ?>
					...
					<div class="hidden"><input type="text" class="form-control" name="company_code" value="<?= isset($transaction_company_code) ? $transaction_company_code : ''?>"/></div>

					<div class="hidden"><input type="text" class="form-control filing_id" name="filing_id" value="<?= isset($filing->id) ? $filing->id : ''?>"/></div>
					<!-- <div style="margin-bottom: 23px; margin-top: 20px;">
						<h3>Filing</h3>
					</div> -->
					<div class="form-group" style="margin-top: 20px;">
				...
				<div id="w2-setup" class="incorp_content">
				  <?php $attrib = array('class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form', 'id' => 'setup_form');
					...
					<div class="hidden"><input type="text" class="form-control" name="client_signing_info_id" value="<?= isset($client_signing_info[0]->id) ? $client_signing_info[0]->id : ''?>"/></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group fieldGroup_contact_email" style="display: block !important;">
								<input type="text" class="form-control input-xs check_empty_contact_email main_contact_email" id="contact_email" name="contact_email[]" value="<?= isset($client_contact_info[0]->contact_email) ? $client_contact_info[0]->contact_email : ''?>" style="width:400px;text-transform:uppercase;"/>
